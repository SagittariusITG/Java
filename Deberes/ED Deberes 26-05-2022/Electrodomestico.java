...
public class Electrodomestico{
    ...
    // Creamos una funcion que compruebe las dos referencias.
    private void comrpobar(String a_comprobar){
        boolean encontrado = false;

        this.consumoEnergetico = a_comprobar;              //Por defecto.
        this.color = a_comprobar;              //Por defecto.
        a_comprobar = a_comprobar.toUpperCase();
        for (int i = 0 ; i < codigos.length && !encontrado ; i++){
          if (colores[i].equals(a_comprobar)){
            encontrado = true;
            this.color = a_comprobar;
          }
          if (codigos[i].equals(a_comprobar)){
            encontrado = true;
            this.consumoEnergetico = a_comprobar;
          }
        }
